...
namespace WPCordovaClassLib.Cordova.Commands
{
    ...
    public class SplashScreen : BaseCommand
    {
        ...
        public void hide(string options = null)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                (((PhoneApplicationPage)((Application.Current.RootVisual as PhoneApplicationFrame).Content)).FindName("SplashScreen") as Image).Visibility = Visibility.Collapsed;
            });

            /*Console.WriteLine("####### hide meghívva");
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                if (popup.IsOpen)
                {
